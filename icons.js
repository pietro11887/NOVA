...
(function () {
  ...
  const UI = {
    ...
    cart: `<path d="M3 5h3.2l2.4 12.2a2 2 0 002 1.6h9.6a2 2 0 002-1.6L24 8.5H7"/><circle cx="12" cy="25" r="2"/><circle cx="21" cy="25" r="2"/>`,
    heart: `<path d="M16 26.5C6.5 20.5 3.5 15.6 3.5 11.4A6.9 6.9 0 0116 8a6.9 6.9 0 0112.5 3.4c0 4.2-3 9.1-12.5 15.1z"/>`,
    heartFull: `<path d="M16 26.5C6.5 20.5 3.5 15.6 3.5 11.4A6.9 6.9 0 0116 8a6.9 6.9 0 0112.5 3.4c0 4.2-3 9.1-12.5 15.1z" fill="currentColor"/>`,
    flame: `<path d="M16 3s1.5 5-2.5 8.5C10 14.5 8 17.4 8 20.5A8 8 0 0024 21c0-3.2-1.6-5.6-3-7.5-.7 1.4-1.6 2.2-2.6 2.5.8-3.6-.4-9-2.4-13z"/>`,
  ...
  const put = (key, tx, ty, s, extra = "", cls = "") =>
    `<g transform="translate(${tx} ${ty}) scale(${s})"><g class="${cls}">${APPS[key]}</g>${extra}</g>`;

  // fiammella del gas (doppia: alone blu + cuore chiaro)
  const flame = (x, y, d) =>
    `<g transform="translate(${x} ${y})">
       <path class="flame" style="animation-delay:${d}s" d="M0 0c-2.4-3.2-2.4-6.4 0-9c2.4 2.6 2.4 5.8 0 9z" fill="#5aa7e8"/>
       <path class="flame" style="animation-delay:${d + 0.12}s" d="M0 0c-1.2-1.8-1.2-3.6 0-5c1.2 1.4 1.2 3.2 0 5z" fill="#a8dcff"/>
     </g>`;
  // filo di vapore che sale
  const wisp = (x, y, d) =>
    `<g transform="translate(${x} ${y})">
